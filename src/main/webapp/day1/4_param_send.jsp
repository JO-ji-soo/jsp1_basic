...
<body>
	...
	<ul>
		...
		<!-- age는 null -->
		<li><a href="5_param_receive.jsp?name=김사나&age">name,age 2개의 파라미터 보내기-age값 없을 때</a></li>
		<!--age는 length가 0인 문자열 -->
	...
	<ul>
		...
		<!-- 2개 값이 모두 출력됩니다 -->
		<li><a href="6_selectBy.jsp?name=sana">name,age 2개의 파라미터 보내기-age 파라미터 없을 때</a></li>
		<!-- age는 null -->
		<li><a href="6_selectBy.jsp?name=김사나&age">name,age 2개의 파라미터 보내기-age값 없을 때</a></li>
		<!--age는 length가 0인 문자열 -->
	</ul>
</body>
</html>